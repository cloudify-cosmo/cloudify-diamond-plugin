...
class CloudifyHandler(Handler):
    ...
    def __init__(self, config=None):
        """
          Create a new instance of cloudifyHandler class
        """
    ...
    def get_default_config_help(self):
        ...
        """
        config = super(CloudifyHandler, self).get_default_config_help()
    ...
    def get_default_config(self):
        ...
        """
        config = super(CloudifyHandler, self).get_default_config()
    ...
    def __del__(self):
        """
          Destroy instance of the cloudifyHandler class
        """
